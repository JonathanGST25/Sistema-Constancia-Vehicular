...
//VARIABLE PARA SABER EL CHECK ACTUAL
$check = 'checkTramite';
...
$consulta = "SELECT count(*) AS conteo FROM Citas, Vehiculos, Catalogo_Marca WHERE Vehiculos.vehiculoId = Citas.vehiculoId AND Catalogo_Marca.marcaId = Vehiculos.marcaId AND
    Citas.estatusPlataId != 'NULL' AND DATE(Citas.fecha_sol_plata) = '$fechaHoy' AND Citas.estatusPlataId = 2";
...
AND Citas.estatusPlataId != 'NULL' AND DATE(Citas.fecha_sol_plata) = '$fechaHoy' AND Citas.estatusPlataId = 2 ORDER BY Citas.fecha_sol_plata DESC LIMIT $registro_inicial, $registros_por_pagina";
